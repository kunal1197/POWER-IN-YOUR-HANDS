...
#x1:hover {
  ...
  <body id="page-top">
    ...
    <div style="margin:100px 100px 50px 100px";>
        <!--Image-->
        <span class="fluid_image" style="display:block;background:url(https://d1x0je2yh2wyb8.cloudfront.net/5/9/4d7f98db-eabc-44f9-9ee5-37bc1661b3dc.WyI4OTJ4NDUwIiwiY3JvcCJd.jpg) no-repeat 50% 50%; width:100%; max-width:500px; height:225px"></span>

      <h1>Waste collecting</h1>
