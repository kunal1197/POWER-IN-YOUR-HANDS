...
#x1:hover {
  ...
  <body id="page-top">
    ...
    <div style="margin:100px 100px 50px 100px";>
    <h1> URBAN WASTE MANAGEMENT </h1>
    <span class="fluid_image" style="display:block;background:url(https://d1x0je2yh2wyb8.cloudfront.net/1/9/4d7f9cd4-0040-4164-a747-37c01661b3dc.WyI4OTJ4NDUwIiwiY3JvcCJd.jpg) no-repeat 50% 50%; width:100%; max-width:500px; height:225px"></span>
<h1>Creating healthier places to live and work</h1>
<p style="text-size:10px";>Waste is a universal and highly visible phenomenon. Attitudes towards solid waste are often contradictory. Affluent societies often see it plainly as garbage or an environmental problem, but in many cities in Africa and other developing countries it is an important and flexible source of income for the large part of urban population and provides raw material to many sectors of economy.</p>
<p style="text-size:10px";>Waste collectors form a vital part of the economy in nearly every city of the developing world. Operating on the streets, kerbsides and dumps, this group of people collect, sort, clean, recycle and sell material thrown away by others, therefore contributing to public health, sanitation and environmental sustainability. According to estimates, “about 1 per cent of the urban population – at least 15 million people – survive by salvaging recyclables from waste”, in the developing world.</p>
<p style="text-size:10px";>Practical Action are working with some of the poorest communities to safely and securely improve their waste management and collection methods. This brings improvements to the health of the slum dwelling families with the creation of safer healthier places to live and work.</p>
...
<ul>
    ...
    <li>We influence national and global policies in waste m</li>
</ul>
    </div>
      <!--Impact-->
      <div class="t2";>
