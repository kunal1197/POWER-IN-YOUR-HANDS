...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <div style="margin:0px 5px 0px 5px";>
       ...
       <h1 id="heading" style="margin-top: 50px; color: blue"; >Take a Pledge</h1>
        <p>Prime Minister Shri Narendra Modi exhorted people to fulfill Mahatma Gandhi's vision of Clean India.</p>
        <p>The 'Swachh Bharat Abhiyan' is a massive mass movement that seeks to create a Clean India.</p>
        <p>Cleanliness was very close to Mahatma Gandhi's heart. A clean India is the best tribute we can pay to Bapu</p>
        <p>when we celebrate his 150th birth anniversary in 2019. Mahatma Gandhi devoted his life so that India attains 'Swarajya'.</p>
        <p>Now the time has come to devote ourselves towards 'Swachchhata' (cleanliness) of our motherland.</p>
        <h1>What requirements should be set?</h1>
        <ul>
        <li> to prevent spreading of diseases</li>
        <li> to reduce the nutrients and other pollutants released to recipient waters,
                and</li>
        <li> to recycle nutrient resources into agriculture or other production.</li>
        </ul>
