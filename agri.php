...
<body id="page-top" style="background-image:url('http://www.freeppt.net/background/green_Agriculture_ppt_backgrounds.jpg');background-repeat: no-repeat; background-size: 1500px 3000px;opacity:0.5px;">
    <!-- Navigation -->
    ...
    <p><strong>Rs 1000</strong> could fund a pedal water pump to irrigate a large plot of land up to 1000m<sup>2</sup></p>
     <button href="donate" id="donate" style="vertical-align:middle"><span>DONATE </span></button>        </div>
        ...
        <h1 style="text-shadow: 2px 2px green;style="margin:80px 250px 100px 100px;">RAINWATER HARVESTING</h1>
